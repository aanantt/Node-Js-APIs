...
// create a "post"
router.post('/post', isAuthenticated, upload.array('images', 4), (req, res) => {
...
//dislike a post
router.delete('/removelike/:postid', isAuthenticated, (req, res) => {
    const params = req.params;
    console.log(req.params);
    const sql = `update post set likes = likes - 1 where id = '${req.params.postid}'`;
...
router.get('/post/:author', isAuthenticated, (req, res) => {
    var newData = []
    var newDict = {}
